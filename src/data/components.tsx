...
export const componentDataMap: Record<string, ComponentData> = {
  Button: {
    name: "Button",
    description:
      "A versatile button component with customizable styles and actions.",
...
/>`,
  ...
  Tooltip: {
    name: "Tooltip",
    description:
      "Interactive tooltips that provide contextual information on hover.",
    category: "Feedback",
    examples: [
      {
        title: "Basic Tooltip",
...
export const categories: Category[] = [
  ...
  {
    name: "Feedback",
    components: ["Tooltip", "ToastPopUp", "Banner"],
  },
  {
    name: "Data Display",
